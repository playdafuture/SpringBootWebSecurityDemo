...
import com.jinqiu.app.ui.model.request.UserLoginRequestModel;
...
public class AutheticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res,
		...
		res.addHeader(SecurityConstants.HEADER_STRING, SecurityConstants.TOKEN_PREFIX_STRING + tokenString);
